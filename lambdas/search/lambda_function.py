...
def search_papers(query: str, page: int = 0, page_size: int = 10, sort_by: str = "relevance"):
    ...
    try:
        ...
        return {
            "papers": papers,
            "total_results": len(papers) + (page * page_size),  # Approximation since arXiv API doesn't provide total count
            "page": page,
            "page_size": page_size,
...
if __name__ == "__main__":
    ...
    def api_search_papers(
        ...
        sort_by: str = Query("relevance", description="Sort criterion: relevance, submitted_date, or last_updated")
    ):
